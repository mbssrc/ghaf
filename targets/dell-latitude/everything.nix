...
#
{
  ...
  dell-latitude = generation: variant: extraModules: let
    hostConfiguration = lib.nixosSystem {
      ...
      modules =
        [
          ...
          self.nixosModules.hw-dell-latitude
          ...
          in {
            ...
            systemd.services."microvm@element-vm".after = ["pulseaudio.service"];
            systemd.services."microvm@element-vm".requires = ["pulseaudio.service"];
            ...
            ghaf = {
              ...
              hardware.ax88179_178a.enable = false;
              hardware.tpm2.enable = true;

              # have to add/enable libfprint-2-tod1-broadcom?!?
              hardware.fprint.enable = false;
          ...
          ({config, ...}: {
            ...
            in [
              "intel_iommu=on,sm_on" #preempt=voluntary
              "iommu=pt"
...
in [
  (dell-latitude "7230" "debug" debugModules)
  (dell-latitude "7230" "release" releaseModules)
]
