...
in
{
  ...
  mkXdgChannel =
    ...
    }:
    {
      ...
      readWrite =
        ...
        // optionalAttrs (graphicsTarget != null) {
          ${graphicsTarget} = {
            inherit mountPoint;
            user = "root";
            group = "users";
  ...
  mkIdentityChannel =
    ...
    {
      mode = "trusted";
      readWrite = optionalAttrs (writer != null) {
        ${writer} = {
          inherit mountPoint;
          user = "root";
          group = "root";
  ...
  mkPublicKeysChannel =
    ...
    {
      mode = "untrusted";
      readWrite = optionalAttrs (rwParticipant != null) {
        ${rwParticipant} = {
          inherit mountPoint;
          user = "root";
          group = "root";
  ...
  mkDesktopShareChannel =
    ...
    }:
    {
      mode = "untrusted";
      readWrite =
        optionalAttrs (graphicsTarget != null && !selfOnly) {
          ${graphicsTarget} = {
